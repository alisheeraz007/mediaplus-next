                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/digital-marketing/ui-ux-design-services" data-aos="fade-up" data-aos-duration="800">
                                    UI/UX
                                </Link>
                            </div>
                            ...
                            <h1 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="500">
                                High-Conversion UI/UX Design & Research
                            </h1>
                            <h3>
                                User-centric digital interfaces engineered to eliminate friction and fuel product adoption
                            </h3>
                            <p data-aos="fade-up" data-aos-duration="1400">
                                Stop guessing why users leave your website. We engineer intuitive user interfaces and user experience maps, combining objective behavior tracking, responsive layout component engineering, and interactive clickable prototypes to ensure clear product conversion tracking.
                            </p>
                            ...
                            <div className='row cardDivOver'>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>+55% Avg</h3>
                                        <p>Form Completions</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>-42% Average</h3>
                                        <p>Bounce Rate Drops</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Request an Interface Friction & Layout Audit</h5>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                User-centric design architectures built to remove conversion friction
                            </h2>
                        </div>
                        <div className='col-md-12'>
                            <div className='row countsRow'>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="100">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Building intuitive structural maps that outline exactly how your users navigate from landing pages to final purchases.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="300">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Creating clean black-and-white interface skeletons to arrange page elements before applying color styling.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="500">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Component-Driven Web UI Design
                                        </h4>
                                        <p>
                                            Designing responsive layouts utilizing reusable button, card, and form elements for clean developer handoffs.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Interactive Clickable Web Prototypes
                                        </h4>
                                        <p>
                                            Constructing live, clickable interface models that allow you to test user flows before writing any code.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Testing layouts across mobile devices to ensure tap areas and navigation are intuitive on small screens.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Behavioral Heatmap & Scroll Audits
                                        </h4>
                                        <p>
                                            Tracking user mouse tracks and scroll depths to uncover hidden design elements that cause users to abandon pages.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-5 pr-5'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Industry-leading prototyping systems optimized for smooth engineering handoffs
                            </h2>
                        </div>
                        <div className='col-md-7'>
                            <div className='row techStackMain'>
                                ...
                                <div className='col-md-3 col-6' data-aos="fade-up" data-aos-duration="700">
                                    <div className='techStack'>
                                        FontAwesome Pro & Custom SVG Libraries
                                    </div>
                                </div>
                                <div className='col-md-3 col-6' data-aos="fade-up" data-aos-duration="700">
                                    <div className='techStack'>
                                        Golden Ratio Layout Grids
                                    </div>
                                </div>
                                <div className='col-md-3 col-6' data-aos="fade-up" data-aos-duration="700">
                                    <div className='techStack'>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            What is the main difference between UI design and UX design inside a product?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            UX (User Experience) design covers the strategy, structure, and logic behind how a user flows through a site. UI (User Interface) design applies the colors, branding, fonts, and visual polish to those structural layouts.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            How do custom Figma design systems make future software development faster?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            We build modular design components. This creates a shared library of buttons, inputs, and tables, allowing your software developers to copy code snippets instantly and scale layouts with perfect consistency.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq3"
                                        >
                                            Will your team test the interactive page wireframes on real mobile devices during the project?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq3"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. We build high-fidelity, responsive prototypes that look and feel like a live app on your phone, allowing you to test tap zones and menu usage before coding begins.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq4"
                                        >
                                            How do you identify the exact design friction points causing users to leave our current site?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq4"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            We use live heatmaps and session recording tools to see exactly where users get confused, scroll backward, or abandon a form, allowing us to fix real usability issues.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq5"
                                        >
                                            Do you deliver raw, editable development files upon project completion?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq5"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Absolutely. You receive organized, fully layered Figma files with global styles, responsive auto-layouts, and component libraries set up for your engineering team.
                                        </div>
                                    </div>
                                </div>
