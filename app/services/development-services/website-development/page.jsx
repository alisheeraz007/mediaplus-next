    ...
    return (
        <div className='mainServicePage subServicesPage overFlowXHidden'>
                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/development-services/website-development" data-aos="fade-up" data-aos-duration="800">
                                    Website Development
                                </Link>
                            </div>
                            ...
                            <h1 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="500">
                                Performance-First Website Development Services
                            </h1>
                            <h3>
                                Custom websites built to turn visitors into active customers
                            </h3>
                            <p data-aos="fade-up" data-aos-duration="1400">
                                We engineer fast, secure, and strategically structured websites designed to do more than look good, they drive measurable growth. Every page is built with pristine performance, modern design, and search visibility in mind.
                            </p>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Request a Custom Website Proposal</h5>
                            ...
                            <div className='row countsRow'>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="100">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Tailored design systems built from scratch to match your visual brand identity.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="300">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Pristine coding practices ensuring rapid load times and clean performance scores.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="500">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Layouts designed to work flawlessly across all screen sizes, from mobile to desktop.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Easy-to-use editor dashboards that allow your team to update text and images effortlessly.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Clean page layouts, semantic code structure, and metadata built in from day one.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Standard security configurations and protection setups to keep user data completely safe.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div className='sectionProcess'>
                <div className='container'>
                    <h4>Our Process</h4>
                    <h2>From initial blueprint design to a fast, live site</h2>
                    ...
                    <div className='processCardMain'>
                        <div className='processCard'>
                            ...
                            <h3>Discovery</h3>
                            <p>
                                Mapping out user journeys, visual goals, and specific technical features required for the build.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Design</h3>
                            <p>
                                Constructing wireframes and layout prototypes to align on style before writing code.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Engineering</h3>
                            <p>
                                Developing clean interfaces and a structured layout for responsive performance.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Launch</h3>
                            <p>
                                Strict quality testing, domain connection, and training on how to use your new platform.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-5 pr-5'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                The right foundation for speed and stability
                            </h2>
                        </div>
                        ...
                        <div className="col-md-7">
                            <div className="accordion accordion-flush" id="faqAccordion">
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            How long does a typical website project take to complete?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Most custom website builds are completed within 3 to 6 weeks. The exact timeline depends on the complexity of your requirements, the number of pages, and how quickly we receive feedback on design drafts.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            Will I be able to update content on my own after launch?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes, absolutely. We build your site on top of clean, easy-to-use visual editors. Before handover, we will take your team through a complete, step-by-step video training session so you can easily change text, swap images, and add new pages on your own.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. We provide ongoing support plans that cover everything from hosting management, visual content updates, security patches, plugin updates, and performance monitoring to keep your site fast and safe.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq4"
                                        >
                                            Will my new website be fully mobile-friendly and optimized for search?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq4"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. Responsive design and on-page SEO structure are built into every single build from day one. Your website will adapt perfectly to all screen sizes and include search-ready page titles, speed optimizations, and semantic formatting.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq5"
                                        >
                                            Can you work with our existing website, or do you only build from scratch?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq5"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            We handle both. Whether you want a complete redesign to improve loading speed and lead generation, or you need to build a brand-new digital presence from the ground up, we align our workflow to match your current needs.
                                        </div>
                                    </div>
                                </div>
