                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/erp-and-crm/accounting-software" data-aos="fade-up" data-aos-duration="800">
                                    Accounting Software
                                </Link>
                            </div>
                            ...
                            <div className='row cardDivOver'>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>150M+</h3>
                                        <p>Ledgers Reconciled</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>100%</h3>
                                        <p>Tax Audits Passed</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>-75%</h3>
                                        <p>Manual Entry Saved</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Request a Corporate General Ledger Architecture Scope</h5>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            What is ACID compliance and why is it critical for our company's accounting software?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            Can this software connect directly to our international bank accounts to download transactions?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq3"
                                        >
                                            How easy is it for an external auditor to review our financial history inside this platform?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq3"
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq4"
                                        >
                                            Can the system automatically handle currency adjustments for cross-border vendor payments?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq4"
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq5"
                                        >
                                            How does the software handle monthly expense matching for physical paper receipts?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq5"
