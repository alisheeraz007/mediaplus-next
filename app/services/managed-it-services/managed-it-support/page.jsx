                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/managed-it-services/managed-it-support" data-aos="fade-up" data-aos-duration="800">
                                    Managed IT Support
                                </Link>
                            </div>
                            ...
                            <h1 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="500">
                                Enterprise Managed IT Support Services
                            </h1>
                            <h3>
                                Proactive infrastructure monitoring and rapid-response technical engineering
                            </h3>
                            <p data-aos="fade-up" data-aos-duration="1400">
                                Keep your corporate operations running at peak velocity. We deliver end-to-end managed IT infrastructure support, blending real-time network monitoring, automated endpoint patching, and dedicated tier-3 technical helpdesks to eliminate operational downtime before it hits your bottom line.
                            </p>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Request an IT Infrastructure Support Consultation</h5>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Proactive infrastructure health tracking engineered for zero business disruption
                            </h2>
                        </div>
                        <div className='col-md-12'>
                            <div className='row countsRow'>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="100">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Continuous automated oversight of your servers, routers, and switches to capture hardware bottlenecks instantly.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="300">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Proactive Endpoint Patch Management
                                        </h4>
                                        <p>
                                            Running silent background updates for operating systems and critical software across all employee machines.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="500">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Dedicated Tier-1 to Tier-3 Helpdesk
                                        </h4>
                                        <p>
                                            Direct on-demand technical phone and remote-desktop support for your staff's daily software challenges.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Setting up automated, encrypted backup intervals and regularly testing recovery speeds for disaster protection.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Strategic Virtual CIO (vCIO) Advisory
                                        </h4>
                                        <p>
                                            Delivering regular technical health audits, hardware lifecycle roadmaps, and budget planning consulting.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Tracking corporate computer ages, managing active software licenses, and coordinating warranty replacements.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-5 pr-5'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Enterprise operations monitoring suites optimized for predictive network management
                            </h2>
                        </div>
                        <div className='col-md-7'>
                            <div className='row techStackMain'>
                                ...
                                <div className='col-md-3 col-6' data-aos="fade-up" data-aos-duration="700">
                                    <div className='techStack'>
                                        Veeam Availability Suite & Datto SIRIS
                                    </div>
                                </div>
                                <div className='col-md-3 col-6' data-aos="fade-up" data-aos-duration="700">
                                    <div className='techStack'>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            What is the difference between a reactive IT guy and a Managed IT Support model?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Reactive support only acts after something breaks, leading to expensive down-time. Our managed model monitors your systems 24/7 to catch and fix warning signs (like a failing hard drive) before your team even notices a problem.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            How fast does your support team respond when an employee submits a critical ticket?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Critical priority-1 tickets (such as a server crash) receive emergency engineering attention within 15 minutes. Standard day-to-day software queries are picking up within an hour.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq3"
                                        >
                                            Can you support a hybrid workforce where half our team works from home?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq3"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. We install lightweight, secure background agents on remote company laptops, allowing us to deploy patches, push updates, and fix employee software issues safely over any internet connection.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq4"
                                        >
                                            Do your monthly fees scale unexpectedly if our staff opens a high volume of tickets?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq4"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            No. We operate on a predictable flat-rate monthly pricing structure per user or per device. This aligns our goals: we both want your network running perfectly so tickets stay low.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq5"
                                        >
                                            How do you handle hardware failures like a cracked laptop screen or bad server RAM?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq5"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Our engineers handle everything from diagnostics to coordination. We deal with device warranties, procure corporate replacement parts, and stage the machinery so your worker gets back online fast.
                                        </div>
                                    </div>
                                </div>
