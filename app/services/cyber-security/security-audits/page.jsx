                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/cyber-security/security-audits" data-aos="fade-up" data-aos-duration="800">
                                    Security Audits
                                </Link>
                            </div>
                            ...
                            <h3>
                                In-depth risk assessments designed to find hidden technical vulnerabilities
                            </h3>
                            <p data-aos="fade-up" data-aos-duration="1400">
                                Discover exactly where your digital defenses are weak before attackers do. We execute deep configuration audits across your cloud architectures, internal networks, and software applications to identify security gaps and deliver clear compliance roadmaps.
                            </p>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Request a Comprehensive Security Audit</h5>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Rigid compliance mapping engineered to expose system vulnerabilities
                            </h2>
                        </div>
                        <div className='col-md-12'>
                            <div className='row countsRow'>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="100">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Configuration Safety Sweeps
                                        </h4>
                                        <p>
                                            Analyzing your cloud, server, and firewall settings to detect weak or default access parameters.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="300">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Evaluating your technical infrastructure against strict global regulations like ISO 27001, SOC2, and GDPR.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="500">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Auditing employee account privileges to verify that data access boundaries are correctly enforced.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Checking backup environments and local files to ensure sensitive customer data is completely encrypted.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Internal Process Appraisals
                                        </h4>
                                        <p>
                                            Reviewing your IT team’s onboarding, offboarding, and incident response protocols for operational gaps.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Prioritized Remediation Blueprints
                                        </h4>
                                        <p>
                                            Providing a clear, step-by-step technical guide ranking your system risks from critical to low.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='container'>
                    ...
                    <div className='processCardMain'>
                        <div className='processCard'>
                            ...
                            <h3>Assessment</h3>
                            <p>
                                Gathering network maps, interviewing core IT personnel, and documenting current access policies.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <p>
                                Aligning your current infrastructure setup against standard corporate regulatory requirements and attack matrix histories.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <p>
                                Scanning internal server codebases, checking permission controls, and tracking missing system patches.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Validation</h3>
                            <p>
                                Packaging a comprehensive technical report, ranking identified risks, and presenting clear mitigation paths to your team.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-5 pr-5'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Enterprise-grade defensive scanners engineered for deep compliance checking
                            </h2>
                        </div>
                        ...
                        <div className="col-md-7">
                            <div className="accordion accordion-flush" id="faqAccordion">
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            Will running a security audit slow down or crash our active business software?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            No. Security audits focus primarily on configuration reviews and passive database scans. We coordinate resource-intensive scans during your off-peak operational hours to guarantee zero user disruptions.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            How often should our corporation conduct a thorough security audit?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Industry compliance standards strongly recommend a comprehensive audit at least once a year, or immediately following any major network architecture changes or software platform upgrades.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            An audit is a defensive review checking if your systems comply with security rules and configurations. A penetration test is an active, controlled simulation of a live cyberattack designed to break into your network.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq4"
                                        >
                                            Do you help us fix the vulnerabilities you find during the audit?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq4"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            We provide a completely detailed technical remediation roadmap explaining exactly how to patch every gap. If your internal team needs engineering support, we can deploy our security team to resolve the issues.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq5"
                                        >
                                            Can your audit help our company pass a formal SOC2 or ISO certification?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq5"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. Our audits are mapped directly to the control criteria required by SOC2 and ISO 27001, making them a perfect baseline to locate and fix gaps before your official external audit begins.
                                        </div>
                                    </div>
                                </div>
