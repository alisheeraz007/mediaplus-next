                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/cyber-security/endpoint-protection" data-aos="fade-up" data-aos-duration="800">
                                    Endpoint Protection
                                </Link>
                            </div>
                            ...
                            <h3>
                                Centralized threat detection and real-time isolation for all corporate laptops and devices
                            </h3>
                            <p data-aos="fade-up" data-aos-duration="1400">
                                Stop ransomware before it spreads across your network. We deploy enterprise Endpoint Detection and Response (EDR) agents to monitor your corporate laptops, mobile devices, and servers identifying and isolating device threats in seconds.
                            </p>
                            ...
                            <div className='row cardDivOver'>
                                ...
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>{`< 3s`}</h3>
                                        <p>Isolation Response</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>100%</h3>
                                        <p>Ransomware Stopped</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Request an Endpoint Security Deployment Plan</h5>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Device-level behavioral monitoring built to isolate malware instantly
                            </h2>
                        </div>
                        <div className='col-md-12'>
                            <div className='row countsRow'>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="100">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Installing advanced software agents that look for malicious code behavior rather than relying on outdated file scans.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="300">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Automated kill-switches that separate a compromised laptop from the company network in seconds to protect other devices.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="500">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Centralized dashboards that push critical security updates to all employee computers automatically.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Local USB Port Restrictions
                                        </h4>
                                        <p>
                                            Hardening device parameters to block unauthorized flash drives from executing code or stealing files.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Encrypted Hard Drive Enforcement
                                        </h4>
                                        <p>
                                            Enforcing full disk encryption keys across all laptops so data remains unreadable if a device is physically stolen.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Real-Time Threat Hunting Logs
                                        </h4>
                                        <p>
                                            Streaming telemetry profiles directly into a central security hub to spot stealthy hacking behavior.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='container'>
                    ...
                    <div className='processCardMain'>
                        <div className='processCard'>
                            ...
                            <h3>Assessment</h3>
                            <p>
                                Inventorying all active company laptops, mobile hardware platforms, operating versions, and active antivirus profiles.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                        ...
                        <div className='processCard'>
                            ...
                            <p>
                                Launching central management dashboards, installing lightweight EDR agents, and pushing disk encryption keys.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Validation</h3>
                            <p>
                                Simulating live safe-malware actions to trigger agent blocks, testing remote update streams, and activating live security tracking logs.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-5 pr-5'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Next-generation endpoint sensors engineered for real-time memory monitoring
                            </h2>
                        </div>
                        <div className='col-md-7'>
                            <div className='row techStackMain'>
                                ...
                                <div className='col-md-3 col-6' data-aos="fade-up" data-aos-duration="700">
                                    <div className='techStack'>
                                        Windows PowerShell & macOS Zsh Scripts
                                    </div>
                                </div>
                                <div className='col-md-3 col-6' data-aos="fade-up" data-aos-duration="700">
                                    <div className='techStack'>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            How is Next-Gen EDR software different from a standard retail antivirus?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Standard antivirus only blocks known malicious files. Next-Gen EDR monitors system memory and application behavior. If a clean application suddenly behaves abnormally, the EDR recognizes the threat and stops it instantly.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            Will installing an EDR monitor slow down our employees' daily laptop performance?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            No. We deploy lightweight cloud-native agents that execute security calculations in the cloud, utilizing less than 1% of device CPU and memory to ensure a fast user experience.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq3"
                                        >
                                            What happens if an employee's laptop gets infected while working on home Wi-Fi?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq3"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            The EDR agent operates directly on the device. The moment it catches a malicious script at home, it isolates the laptop from the internet, preventing the malware from spreading back to your corporate servers when they connect.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq4"
                                        >
                                            Can we monitor personal smartphones if employees use them to read work emails?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq4"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. We configure Mobile Device Management (MDM) profiles that build an isolated corporate partition on personal phones, protecting business data without accessing the employee's private apps or photos.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq5"
                                        >
                                            What happens if an employee loses a company laptop at an airport?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq5"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Because we enforce full disk encryption (BitLocker/FileVault), the data remains completely unreadable without the security key. We can also issue a remote erase command from our dashboard to wipe the hardware completely the moment it boots up.
                                        </div>
                                    </div>
                                </div>
