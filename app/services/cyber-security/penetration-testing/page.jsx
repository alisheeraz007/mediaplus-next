                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/cyber-security/penetration-testing" data-aos="fade-up" data-aos-duration="800">
                                    Penetration Testing
                                </Link>
                            </div>
                            ...
                            <h3>
                                Controlled real-world cyberattack simulations designed to breach and test your defenses
                            </h3>
                            <p data-aos="fade-up" data-aos-duration="1400">
                                Test your security resilience against real attack scenarios. Our certified ethical hackers simulate modern cyber threats to actively breach your networks, applications, and APIs, exposing deep entry points and showing exactly how to defend them.
                            </p>
                            ...
                            <div className='row cardDivOver'>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>500+</h3>
                                        <p>Exploits Executed</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>94%</h3>
                                        <p>Critical Risks Found</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>0% Post-Fix</h3>
                                        <p>Breach Success Rate</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Request a Penetration Testing Scope</h5>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Offensive hacking simulations built to uncover critical exploit vectors
                            </h2>
                        </div>
                        <div className='col-md-12'>
                            <div className='row countsRow'>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="100">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Simulating attacks targeting your public web portals, corporate email gates, and visible server paths.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="300">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Web Application & API Penetration
                                        </h4>
                                        <p>
                                            Actively injecting code inputs into your software to find bypass cracks in authentication and database controls.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="500">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Evaluating what an attacker could exploit if they successfully compromised a single local office computer or Wi-Fi network.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Attempting to elevate standard user credentials up to administrative root control inside your environment.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Testing local corporate office Wi-Fi networks for weak encryption standards and handshake vulnerabilities.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Exploit Verification Proofs
                                        </h4>
                                        <p>
                                            Providing verified, safe video or photographic proof showing exactly how your internal data was accessed.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='container'>
                    ...
                    <div className='processCardMain'>
                        <div className='processCard'>
                            ...
                            <h3>Assessment</h3>
                            <p>
                                Defining test boundaries, collecting target IP lists, and establishing communication safe-words.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <p>
                                Researching public domain data, scanning target boundaries, and mapping specific system exploit targets.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <p>
                                Launching payload injections, bypassing authentication layers, and pivoting through internal data networks.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Validation</h3>
                            <p>
                                Cleanly removing test backdoors, compiling exploit proof logs, and delivering a technical remediation brief.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-5 pr-5'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Offensive security frameworks engineered for precise data exploitation
                            </h2>
                        </div>
                        ...
                        <div className="col-md-7">
                            <div className="accordion accordion-flush" id="faqAccordion">
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            Is penetration testing safe, or could it crash our live company production platform?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            It is fully controlled and safe. We define strict rules of engagement before writing code. Our ethical hackers monitor performance metrics continuously, ensuring we validate exploits without corrupting databases or dropping services.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            Do you use automated tools or manual hacking during a penetration test?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            We utilize automated tools for foundational scanning, but 80% of our penetration testing involves advanced manual hacking. Automated software cannot mimic the creative logic an actual threat actor uses to chain minor bugs together.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq3"
                                        >
                                            Will we receive a re-test after our technical team fixes the identified exploits?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq3"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. Our packages include a dedicated round of validation re-testing. Once your engineers implement the patches, we rerun the exact exploit strings to confirm the entry points are completely sealed.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Black-Box testing mimics an outside attacker with zero prior knowledge of your systems. White-Box testing provides our hackers with architectural diagrams and credentials to perform a fast, highly comprehensive internal review.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq5"
                                        >
                                            Do your penetration tests satisfy corporate insurance and compliance mandates?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq5"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. Our comprehensive technical documentation and methodologies satisfy the rigorous third-party penetration testing requirements mandated by PCI-DSS, SOC2, and major cyber insurance providers.
                                        </div>
                                    </div>
                                </div>
