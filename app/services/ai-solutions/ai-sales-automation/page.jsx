                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/ai-solutions/ai-sales-automation" data-aos="fade-up" data-aos-duration="800">
                                    AI Sales Automation
                                </Link>
                            </div>
                            ...
                            <h1 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="500">
                                Predictive AI Sales Automation
                            </h1>
                            <h3>
                                Automated outbound prospecting and lead nurturing engines that book meetings
                            </h3>
                            <p data-aos="fade-up" data-aos-duration="1400">
                                Keep your sales pipeline completely full. We design and build automated outbound engines that scour public data to find ideal corporate prospects, write deeply hyper-personalized messaging pitches, and follow up relentlessly to book high-value meetings.
                            </p>
                            ...
                            <div className='row cardDivOver'>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>10k+</h3>
                                        <p>Leads Sourced Monthly</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                                        <h3>65%+</h3>
                                        <p>Email Open Rates</p>
                                    </div>
                                </div>
                                <div className='col-md-3 col-6'>
                                    <div className='over'>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Build a Custom Inbound Sales Engine</h5>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Data-driven outbound engines built to consistently generate meetings
                            </h2>
                        </div>
                        <div className='col-md-12'>
                            <div className='row countsRow'>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="100">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Automated cross-referencing of B2B directories to extract verified corporate email addresses and mobile numbers.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="300">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Hyper-Personalized Copy Generation
                                        </h4>
                                        <p>
                                            AI scripts that scan a prospect’s recent articles or news to craft highly tailored cold email hooks.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="500">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Smart multi-day outbound campaigns that pause automatically the moment a prospect responds.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Technical setup of custom domain parameters and email warmups to prevent spam filtering.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Intent Tracking & Scoring
                                        </h4>
                                        <p>
                                            Analytics that alert salespeople instantly when a prospect opens an email multiple times or views pricing.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Native booking links embedded directly inside pitches to secure consultation slots instantly.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='container'>
                    ...
                    <div className='processCardMain'>
                        <div className='processCard'>
                            ...
                            <h3>Assessment</h3>
                            <p>
                                Defining your ideal customer profile (ICP), value propositions, target job titles, and past winning pitches.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Architecture</h3>
                            <p>
                                Engineering domain tracking variations, crafting personalization logic steps, and structuring multi-channel touchpoints.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <p>
                                Configuring lead enrichment software nodes, testing web scraping criteria, and connecting sales CRM dashboards.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Deployment</h3>
                            <p>
                                Commencing targeted sample outreach runs, verifying total deliverability setups, and scaling out outbound volume.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-5 pr-5'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                High-performance sales pipelines engineered for precision B2B prospecting
                            </h2>
                        </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            Won't sending high-volume cold emails cause our main company website to get marked as spam?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            No. We strictly build insulated infrastructure. We launch dedicated secondary outreach domains and run them through systematic warmup pipelines, ensuring your core company website domain remains completely safe and untouched.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            How personalized are the outbound emails really?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            The personalization goes far beyond generic templates. The AI reads the prospect's exact job description, recent corporate press releases, or LinkedIn posts to find context, and writes a unique introductory hook specific to them.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq3"
                                        >
                                            How do you ensure the email lists are highly accurate and verified?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq3"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            We combine multiple enterprise data layers (like Apollo and Clay) and filter them through live verification loops right before sending. This process catches and drops invalid emails, keeping bounce rates safely below 2%.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq4"
                                        >
                                            Does this system support LinkedIn automation as well, or just email?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq4"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            We build multi-channel engines. The system can find a prospect, send a hyper-personalized email first, wait two days, check for a reply, and then automatically drop a soft profile visit or connection request on LinkedIn.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq5"
                                        >
                                            Can the AI handle the conversation if a prospect replies with a question?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq5"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            We program the AI to identify standard warm responses (such as price requests). It instantly alerts your human sales team and drafts an accurate response template, allowing your reps to step in and secure the deal.
                                        </div>
                                    </div>
                                </div>
