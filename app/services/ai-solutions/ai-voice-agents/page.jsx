    ...
    return (
        <div className='mainServicePage subServicesPage'>
                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/ai-solutions" data-aos="fade-up" data-aos-duration="800">
                                    AI Solutions
                                </Link>
                                <span>/</span>
                                <Link href="/services/ai-solutions/ai-voice-agents" data-aos="fade-up" data-aos-duration="800">
                                    AI Voice Agents
                                </Link>
                            </div>
                            ...
                            <h1 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="500">
                                Autonomous AI Voice Agent Solutions
                            </h1>
                            <h3>
                                High-fidelity, ultra-low latency conversational voice systems for phone operations
                            </h3>
                            <p data-aos="fade-up" data-aos-duration="1400">
                                Automate your inbound phone support and outbound lead qualification with human-sounding voice agents. We engineer smart voice applications that converse naturally without awkward robotic delays, answering queries, routing calls, and scheduling bookings over the phone 24/7.
                            </p>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Request an AI Voice System Blueprint</h5>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Ultra-low latency speech automation built for natural phone interactions
                            </h2>
                        </div>
                        <div className='col-md-12'>
                            <div className='row countsRow'>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="100">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Human-like voice tones, natural inflections, and responsive breathing pauses that eliminate mechanical sound profiles.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="300">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Smart conversational logic that allows human callers to speak over the agent naturally to change topics instantly.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="500">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Intelligent background triage that transfers callers to the exact human department required when needed.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Automated Phone Appointments
                                        </h4>
                                        <p>
                                            In-call scheduling systems where the voice agent updates live availability and locks in calendar slots directly.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Automated summarization systems that structure call transcripts, customer sentiment, and outcomes right after hang-up.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Twilio & Telecom Bridging
                                        </h4>
                                        <p>
                                            Enterprise phone network connections making your voice agent reachable via standard local and global telephone lines.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div className='sectionProcess'>
                <div className='container'>
                    <h4>Our Process</h4>
                    <h2>From structural logic mapping to a fully deployed intelligent workflow</h2>
                    ...
                    <div className='processCardMain'>
                        <div className='processCard'>
                            ...
                            <h3>Assessment</h3>
                            <p>
                                Auditing historical support phone recordings, call flow scripts, and common telephone inquiries.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Architecture</h3>
                            <p>
                                Designing decision-tree call flows, scripting verbal brand personas, and configuring webhook triggers for live databases.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <p>
                                Training the natural language engine on company manuals, configuring telephony paths, and tuning speech-to-text models.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Deployment</h3>
                            <p>
                                Running real-time latency optimization tests, simulating massive concurrent call spikes, and launching your dedicated phone line.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-5 pr-5'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Telephony-optimized frameworks engineered for real-time vocal processing
                            </h2>
                        </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            Will the voice agent sound robotic or have long, awkward pauses?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            No. By pairing ultra-fast language generation models with real-time audio systems, we pull the response delay down below 800 milliseconds. This mimics standard human conversational rhythms, preventing awkward, overlapping pauses.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            What happens if a customer interrupts the voice agent mid-sentence?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Our agents are engineered with native interruption protection. The moment the caller speaks, the agent immediately stops talking, listens to the new input, adjusts its internal logic, and responds to the customer's interruption naturally.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq3"
                                        >
                                            Can the voice agent make outbound calls, or does it only handle inbound traffic?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq3"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            It handles both. It can take inbound customer calls to manage support and book appointments, or it can execute automated outbound phone campaigns to follow up with cold web leads, confirm bookings, or notify clients of order updates.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq4"
                                        >
                                            Is the system capable of routing calls to our human staff?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq4"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. If the call requires complex problem-solving or explicit human assistance, the agent can trigger a seamless telephone transfer, passing the live call directly to your office phone system or specific department.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq5"
                                        >
                                            How does the system record information discussed on the phone call?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq5"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Right when the call finishes, the system converts the call audio into an accurate text transcript. It then extracts key details like customer names, emails, and action items, dropping a structured call summary right into your software dashboard.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-lg-3 col-md-6 col-sm-6 mt-4" data-aos="fade-right" data-aos-duration="800"
                                    ...
                                    <div className="brand-card shadow">
                                        ...
                                        <a href="/services/ai-solutions/ai-chatbots" className="themeBtn">View More</a>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 mt-4" data-aos="fade-right" data-aos-duration="800"
                                    ...
                                    <div className="brand-card shadow">
                                        ...
                                        <a href="/services/ai-solutions/ai-voice-agents" className="themeBtn">View More</a>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 mt-4" data-aos="fade-right" data-aos-duration="800"
                                    ...
                                    <div className="brand-card shadow">
                                        ...
                                        <a href="/services/ai-solutions/business-process-automation" className="themeBtn">View More</a>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 mt-4" data-aos="fade-right" data-aos-duration="800"
                                    ...
                                    <div className="brand-card shadow">
                                        ...
                                        <a href="/services/ai-solutions/ai-customer-support" className="themeBtn">View More</a>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 mt-4" data-aos="fade-right" data-aos-duration="800"
                                    ...
                                    <div className="brand-card shadow">
                                        ...
                                        <a href="/services/ai-solutions/ai-sales-automation" className="themeBtn">View More</a>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 mt-4" data-aos="fade-right" data-aos-duration="800"
                                    ...
                                    <div className="brand-card shadow">
                                        ...
                                        <a href="/services/ai-solutions/ai-crm" className="themeBtn">View More</a>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 mt-4" data-aos="fade-right" data-aos-duration="800"
                                    ...
                                    <div className="brand-card shadow">
                                        ...
                                        <a href="/services/ai-solutions/ai-analytics" className="themeBtn">View More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
