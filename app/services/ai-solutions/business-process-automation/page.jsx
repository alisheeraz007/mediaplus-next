                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            <div className='breadcums'>
                                ...
                                <span>/</span>
                                <Link href="/services/ai-solutions/business-process-automation" data-aos="fade-up" data-aos-duration="800">
                            ...
                            <h3>
                                Hands-free cross-platform workflows engineered to eliminate repetitive tasks
                            </h3>
                            <p data-aos="fade-up" data-aos-duration="1400">
                                Standardise and accelerate your daily business operations. We build custom backend automated ecosystems that pass data between your software platforms, handle administrative tasks, and eliminate costly human operational errors.
                            </p>
                            ...
                            <div className='row cardDivOver'>
                                ...
                                <div className='col-md-3'>
                                    <div className='over'>
                                        <h3>100%</h3>
                                        <p>Data Sync Accuracy</p>
                                    </div>
                                </div>
                                <div className='col-md-3'>
                                    <div className='over'>
                                        <h3>{`< 3s`}</h3>
                                        <p>Workflow Latency</p>
                                    </div>
                                </div>
                                <div className='col-md-3'>
                                    <div className='over'>
                        ...
                        <div className='col-md-4'>
                            <div className='formDiv'>
                                <h5>Request a Workflow Automation Audit</h5>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Frictionless operational sync built to replace manual data entries
                            </h2>
                        </div>
                        <div className='col-md-12'>
                            <div className='row countsRow'>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="100">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Real-time information updates across different cloud apps without file exports.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="300">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            AI systems that extract text, figures, and dates from uploaded PDF invoices or contracts.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="500">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Instant system notifications sent to internal teams or clients when milestones shift.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Scheduled automated scripts that scrub, format, and organize massive batches of data overnight.
                                        </p>
                                    </div>
                                </div>
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        <h4>
                                            ...
                                            Approval Pipeline Controls
                                        </h4>
                                        <p>
                                            Smart workflows that pause tasks and alert managers when explicit structural approvals are needed.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='col-md-4' data-aos="fade-up" data-aos-duration="700">
                                    <div className='countCard'>
                                        ...
                                        <p>
                                            Built-in backup routines that intercept API issues and retry steps to prevent processing gaps
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='container'>
                    ...
                    <div className='processCardMain'>
                        <div className='processCard'>
                            ...
                            <h3>Assessment</h3>
                            <p>
                                Shadowing your team's routine actions to identify slow, repetitive, or error-prone data-entry bottlenecks.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Architecture</h3>
                            <p>
                                Blueprinting visual conditional logic maps, step dependencies, and software integration endpoints.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <p>
                                Writing custom data parsing rules, connecting API webhooks, and syncing secure cloud environments.
                            </p>
                        </div>
                        <div className='processCard'>
                            <div className='countDiv'>
                            ...
                            <h3>Deployment</h3>
                            <p>
                                Running rigorous multi-scenario end-to-end load tests and turning on live, hands-free automation runs.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-5 pr-5'>
                            ...
                            <h2 data-aos="fade-up" data-aos-duration="600">
                                Integration-first architectures built for flawless operational continuity
                            </h2>
                        </div>
                        ...
                        <div className="col-md-7">
                            <div className="accordion accordion-flush" id="faqAccordion">
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq1"
                                        >
                                            What happens if an external app crashes or changes its layout?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq1"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            We build strict error-handling parameters into every workflow. If an API fails, the system safely pauses, records the error log, and sends an urgent notification to your team instead of corrupting your data.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq2"
                                        >
                                            Can your automations extract information from handwritten or blurry PDF documents?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq2"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Yes. By combining Optical Character Recognition (OCR) with advanced vision language models, our workflows accurately extract structured data from scanned invoices, receipts, and notes.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq3"
                                        >
                                            Will this replace our existing software or work with it?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq3"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            It works directly with your current software suite. We do not replace your tools; we build secure digital bridges between them so information flows automatically without human interference.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    <h2 className="accordion-header">
                                        <button
                                            ...
                                            data-bs-target="#faq4"
                                        >
                                            Is our corporate data safe when running through these automated pipelines?
                                        </button>
                                    </h2>
                                    <div
                                        id="faq4"
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Absolutely. We prioritize high-grade encryption protocols and strict API key configurations. For sensitive operations, we deploy self-hosted automation engines so your data never leaves your infrastructure.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item bg-transparent">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            Most businesses save between 20 to 40 hours of manual labor per week within the first 30 days of deployment, allowing staff to reallocate time to high-value revenue tasks immediately.
                                        </div>
                                    </div>
                                </div>
