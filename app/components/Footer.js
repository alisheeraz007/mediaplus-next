        ...
        <footer>
            <button id="scrollTopBtn">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                    <path d="M6 15L12 9L18 15" stroke="white" stroke-width="2.5" stroke-linecap="round"
                        ...
                        <div class="about-footer">
                            ...
                            <ul class="social-link">
                                <li data-aos="zoom-in" data-aos-duration="500" data-aos-delay="400"><a
                                    href="https://www.facebook.com/Mediaplusofficial/"><i class="fab fa-facebook-f"></i></a>
                                </li>
                                ...
                                <li data-aos="zoom-in" data-aos-duration="500" data-aos-delay="600"><a
                                    href="https://www.instagram.com/mediaplusofficial/"><i class="fab fa-instagram"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                    ...
                    <div class="col-md-3" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                        ...
                        <ul class="quick-list">
                            <li data-aos="fade-left" data-aos-duration="500" data-aos-delay="500"><a
                                href="branding-and-graphic-design.php"><i class="fal fa-long-arrow-right"></i> Branding &
                                Graphic Design</a></li>
                            <li data-aos="fade-left" data-aos-duration="500" data-aos-delay="600"><a
                                href="website-and-digital-development.php"><i class="fal fa-long-arrow-right"></i> Website &
                                Digital Development</a></li>
                            <li data-aos="fade-left" data-aos-duration="500" data-aos-delay="700"><a
                                href="mobile-app-development.php"><i class="fal fa-long-arrow-right"></i> Mobile App
                                Development</a></li>
                            <li data-aos="fade-left" data-aos-duration="500" data-aos-delay="800"><a
                                href="digital-marketing-and-promotion.php"><i class="fal fa-long-arrow-right"></i> Digital
                                Marketing & Promotion</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="600">
                        ...
                        <ul class="contactInfo">
                            <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="700"><a
                                href="tel:+971501614417"><i class="fas fa-phone-alt"></i> +971 50 161 4417</a></li>
                            <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="800"><a
                                href="mailto:info@mediaplusuae.com"><i class="fas fa-envelope"></i>
                                info@mediaplusuae.com</a></li>
                            <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="900"><a
                                href="javascript:void(0)"><i class="fas fa-map-marker-alt"></i> Office 906, Business Avenue
                                Building, Al Khabaisi, Dubai, United Arab Emirates</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row copyRight justify-content-center text-center">
