            ...
            <div className="col-md-7">
              <div className="our-app-head">
                ...
                <p data-aos="fade-right" data-aos-duration="1000" data-aos-delay="400">Founded in 2019 in the
                  heart of Dubai, MediaPlus Information Technology has rapidly evolved from a boutique agency
                  into a full-cycle software powerhouse. We specialize in transforming ambitious ideas into
                  market-leading digital platforms.</p>
                <p data-aos="fade-right" data-aos-duration="1000" data-aos-delay="500">Our DNA: Unlike
                  traditional agencies that strictly follow instructions, we innovate. We combine local market
                  insights with global engineering standards to deliver mobile apps, AI solutions, and
                  enterprise platforms that drive growth. We are the team behind success stories like Synera
                  Property and TabeebNow.</p>
                <h4 data-aos="fade-right" data-aos-duration="800" data-aos-delay="600">Our Vision</h4>
                <p data-aos="fade-right" data-aos-duration="1000" data-aos-delay="700">To be the leading digital
                  venture builder in the MENA region, recognized for creating
                  intelligent ecosystems that simplify lives and empower enterprises. We see a future where
                  technology is seamless, intuitive, and accessible to all.</p>
                <h4 data-aos="fade-right" data-aos-duration="800" data-aos-delay="800">Our Mission</h4>
                <p data-aos="fade-right" data-aos-duration="1000" data-aos-delay="900">To accelerate our
                  clients' growth by delivering high-impact, custom technology solutions We
                  are committed to:</p>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <article className="ceo-content">
                ...
                <p data-aos="fade-left" data-aos-duration="800" data-aos-delay="400">Welcome to MediaPlus
                  Information Technology. Since our inception in 2019, we have been driven
                  by a single purpose: to bridge the gap between complex technology and tangible business
                  results</p>
                <p data-aos="fade-left" data-aos-duration="800" data-aos-delay="500">In an era where digital
                  transformation is no longer optional, we stand as your strategic
                  partners. We don't just build software;</p>
                <p data-aos="fade-left" data-aos-duration="800" data-aos-delay="600">we engineer ecosystems.
                  From revolutionizing real estate with Synera to redefining
