                        ...
                        <div className="col-lg-6 col-md-12">
                            <article className="logo-design">
                                ...
                                <p data-aos="fade-left" data-aos-duration="800" data-aos-delay="500">
                                    Synera Property is a Dubai-based agency specializing in residential and commercial
                                    investments, acquisitions, and portfolio management. To support their scaling UAE
                                    operations, we partnered with their team to build a unified, dual-sided digital
                                    infrastructure from the ground up. On the front end, we engineered a clean web portal for
                                    users to seamlessly browse, buy, and rent properties. Concurrently, we developed a custom
                                    backend Property Management CRM that acts as their core operational dashboard, enabling
                    ...
                    <div className="row align-items-center no-gutters">
                        <div className="col-lg-6 col-md-12">
                            <article className="logo-design">
                                ...
                                <p data-aos="fade-right" data-aos-duration="800" data-aos-delay="600"> remaining essentially
                        ...
                        <div className="col-lg-6 col-md-12">
                            <article className="logo-design">
                                ...
                                <p data-aos="fade-left" data-aos-duration="800" data-aos-delay="600">Lorem Ipsum is simply dummy
                                    ...
                                    galley of type and scrambled it to make a type specimen book. It has survived not only five
                                    centuries, but also the leap into electronic typesetting</p>
                                <p data-aos="fade-left" data-aos-duration="800" data-aos-delay="700"> remaining essentially
                                    unchanged. It was popularised in the 1960s with the release of
                                    Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing
                                    software like Aldus PageMaker including versions of Lorem Ipsum.</p>
